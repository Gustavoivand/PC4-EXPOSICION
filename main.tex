...
\title[SMTP \& STP]{Algoritmos MST y STP aplicados en artículos recientes}
...
\subsection{Análisis de complejidad — paso a paso}
    ...
    En la práctica:
    \begin{itemize}
        \item Si MILP se resuelve solo sobre un conjunto pequeño de variables (conflictos), su coste puede ser manejable.
        \item Para instancias urbanas reales (M pequeño relativo a N) el algoritmo resulta práctico.
    \end{itemize}
    \end{frame}

% ------------------------------------------------------------------------
\section{Algoritmo STP}
...
\begin{frame}{Modelo de red y problema STP}
\begin{itemize}
...
\begin{frame}{Algoritmo 2: Entrenamiento Q-learning para STP}
\scriptsize
\begin{algorithm}[H]
\DontPrintSemicolon
...
\begin{frame}{Notación para complejidad (STP)}
Definamos:
\begin{itemize}
...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item STP con Q-learning distribuido: coste aproximadamente lineal en $N$ por ejecución online, sin recopilar el grafo completo.
  \end{itemize}
...
\begin{itemize}
  ...
  \end{itemize}
  \item \textbf{Algoritmo STP (Q-learning distribuido):}
  \begin{itemize}
...
\begin{frame}
\frametitle{Conclusiones específicas del STP con Q-learning}
\begin{itemize}
